...
class HeartCheck(App):
    def build(self):
        sm = ScreenManager()
        sm.add_widget(FirstUp(name='instr'))
        sm.add_widget(SecondUp(name='pulse1'))
